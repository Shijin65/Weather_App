            ...
            <div className="flex lg:grid lg:grid-cols-2 lg:flex-wrap justify-around flex-row gap-5 lg:flex-col lg:w-auto w-full  lg:text-xs md:my-0 my-">
              <div className="sm:flex flex-col">
                ...
                <img
                  ...
                  className="h-10"
                />
                <h1>sunrise <span className="font-bold">{rise}</span></h1>
              </div>
              <div className="sm:flex flex-col">
                ...
                <img
                  ...
                  className="h-10"
                />
                <h1>sunset <span className="font-bold">{set}</span></h1>
              </div>
              <div className="sm:flex flex-col">
                ...
                <img
                  ...
                  className="h-10"
                />
                <h1>sealvl <span className="font-bold">{main.sea_level}m</span></h1>
              </div>
              <div className="sm:flex flex-col">
                ...
                <img
                  ...
                  className="h-10"
                />
                <h1>humidity <span className="font-bold">{main.humidity}g/kg</span></h1>
              </div>
              <div className="sm:flex flex-col ">
                ...
                <img
                  ...
                  className="h-8"
                />
                <h1>wind <span className="font-bold">{wind.speed}m/s</span></h1>
              </div>
            </div>
          </div>
